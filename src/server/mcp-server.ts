...
export class MCPServer {
  ...
  private getCapabilities(): string[] {
    ...
    if (this.config.tools.file.enabled) capabilities.push('file-operations');
    if (this.config.tools.shell.enabled) capabilities.push('shell-commands');
    if (this.config.tools.edit.enabled) capabilities.push('file-editing');
